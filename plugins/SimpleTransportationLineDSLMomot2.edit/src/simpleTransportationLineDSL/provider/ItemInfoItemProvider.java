...
/**
 * This is the item provider adapter for a {@link simpleTransportationLineDSL.ItemInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemInfoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemInfo_creationTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemInfo_creationTime_feature", "_UI_ItemInfo_type"),
				 SimpleTransportationLineDSLPackage.Literals.ITEM_INFO__CREATION_TIME,
				 true,
				 false,
				 false,
	...
	protected void addFinalizationTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemInfo_finalizationTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemInfo_finalizationTime_feature", "_UI_ItemInfo_type"),
				 SimpleTransportationLineDSLPackage.Literals.ITEM_INFO__FINALIZATION_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addTotalLatencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemInfo_totalLatency_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemInfo_totalLatency_feature", "_UI_ItemInfo_type"),
				 SimpleTransportationLineDSLPackage.Literals.ITEM_INFO__TOTAL_LATENCY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleTransportationLineDSLPackage.Literals.ITEM_INFO__SOURCE_ITEMS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_ItemInfo_type") + " " + itemInfo.getCreationTime();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimpleTransportationLineDSLPackage.Literals.ITEM_INFO__SOURCE_ITEMS,
