...
/**
 * This is the item provider adapter for a {@link simpleTransportationLineDSL.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleTransportationLineDSLPackage.Literals.ITEM__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimpleTransportationLineDSLPackage.Literals.ITEM__STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addQualityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Item_quality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Item_quality_feature", "_UI_Item_type"),
				 SimpleTransportationLineDSLPackage.Literals.ITEM__QUALITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleTransportationLineDSLPackage.Literals.ITEM__ITEMINFO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimpleTransportationLineDSLPackage.Literals.ITEM__ITEMINFO,
				 SimpleTransportationLineDSLFactory.eINSTANCE.createItemInfo()));
	}
