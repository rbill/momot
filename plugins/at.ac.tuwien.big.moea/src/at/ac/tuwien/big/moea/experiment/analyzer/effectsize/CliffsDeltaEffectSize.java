...
import at.ac.tuwien.big.moea.experiment.analyzer.Magnitude;
 ...
 * i.e., |d|<0.147 "negligible", |d|<0.33 "small", |d|<0.474 "medium", otherwise
 * "large".
 */
public class CliffsDeltaEffectSize extends AlgorithmEffectSize {
	...
	/**
	 * Use magnitude classification of: J. Romano, J. D. Kromrey, J. Coraggio,
	 * J. Skowronek, Appropriate statistics for ordinal level data: Should we
	 * really be using t-test and cohen's d for evaluating group differences on
	 * the NSSE and other surveys?, in: Annual meeting of the Florida
