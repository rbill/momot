...
public class TransformationSearchOrchestration extends AbstractSearchOrchestration<TransformationSolution> {
	...
	public ITransformationProblem createProblem() {
		...
		if (singleObjectivizerProvider != null) {
			return new ParetoFrontStoringTransformationSearchProblem<ITransformationProblem>(ret, singleObjectivizerProvider);
		}
		return ret;
	}
	

	public void initSingleObjectivizerProvider(SingleObjectivizerProvider provider) {
		this.singleObjectivizerProvider = provider;
	}
	
	public SingleObjectivizerProvider getSingleObjectivizerProvider() {
		return this.singleObjectivizerProvider;
	}
